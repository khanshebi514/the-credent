...
export default function GovtInsurance() {
  ...
  return (
    ...
    <div className="flex justify-stretch max-w-[1280px] m-auto mt-10 flex-col gap-10 mb-10">
   ...
   <div className="flex justify-center items-center gap-6 flex-wrap">
    ...
    <button className="w-[150px] p-4 rounded-none bg-primary text-white  mt-3 hover:bg-[#0099e6]">
            Learn More
        </button>
    </div>
