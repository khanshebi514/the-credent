  ...
  return (
   ...
   >
    ...
    >
        ...
        <p className="font-shadow text-primary text-xl md:text-2xl">ASSESSMENT</p>
        </div>
       ...
       <div className="assessment w-[150px] rounded-full border-[1px] p-[2px] border-gray-500 flex justify-center items-center ">
        ...
        <p className="font-shadow text-primary text-xl md:text-2xl">COORDINATION</p>
       </div>
       ...
       <div className="assessment w-[150px] rounded-full border-[1px] p-[2px] border-gray-500 flex justify-center items-center">
        ...
        <p className="font-shadow text-primary text-xl md:text-2xl">VALIDATION</p>
       </div>
        ...
        <p className="font-shadow text-primary text-xl md:text-2xl">OUR CLIENTS</p>
        </div>
