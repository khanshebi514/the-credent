...
export default function CredCard({image, title, point, background='white'}) {
  ...
  return (
    ...
    <div className="space-y-3 w-full md:w-[66%] md:text-start p-5 ">
        {title ? <h1 className="text-[35px] text-[#222] font-bold my-3">{title}</h1> :<h1 className="text-[25px] text-[#222] my-3"><span className="font-bold">When Do</span> You need Credentialing Services</h1> }
